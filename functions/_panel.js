// UI do painel admin — template levantado do server.js sem alteração
// (era o único trecho server-rendered; a única interpolação é ${dataJson}).
// Os dados entram como JSON e o restante é renderizado no cliente, então o
// mesmo HTML serve tanto para o Express local quanto para as Pages Functions.
export function panelHtml(dataJson) {
